...
          botWallets: botWallets.map(w => w.smartWalletAddress),
          // Backend will detect this to include native ETH balance
          includeNative: true,
        }),
      })
...
          symbol: selectedTokenInfo.symbol,
          // Extra flag for backend to handle native transfer
...
  const handleWithdrawWeth = async () => {
    // If user tries to withdraw ETH as WETH, we inform it's not applicable
